      ...
      builder: (dialogContext) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            const Text('Eliminar T. Precio'),
          ],
        ),
        content: Text(
          '¿Estás seguro de que deseas eliminar el tipo de precio "${tipoPrecio.descripcion}"?\n\nEsta acción no se puede deshacer.',
        ),
        actions: [
          TextButton(
          ...
          ElevatedButton(
            onPressed: () {
              context.read<TipoPrecioBloc>().add(DeleteTipoPrecio(tipoPrecio.idTipoPrecio));
