  ...
  static void show(
    ...
    showDialog(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: Text(
          '¿Estás seguro de que deseas eliminar el servicio "${servicio.descripcion}"?\n\nEsta acción no se puede deshacer.',
        ),
        actions: [
          TextButton(
          ...
          ElevatedButton(
            onPressed: () {
              context.read<ServicioBloc>().add(DeleteServicio(servicio.idServicio));
