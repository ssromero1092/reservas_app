...
class EditListaPrecioDialog {
  static void show(BuildContext context, ThemeData theme, ListaPrecio listaPrecio) {
    final valorController = TextEditingController(text: listaPrecio.valor.toString());
    int selectedIdTipoHospedaje = listaPrecio.idTipoHospedaje;
    int selectedIdTipoPrecio = listaPrecio.idTipoPrecio;
        ...
        builder: (context, setState) => AlertDialog(
          ...
          title: Row(
            children: [
              ...
              const Text('Editar Lista de Precio'),
            ],
          ),
          content: SizedBox(
            ...
            ElevatedButton(
              onPressed: () {
                if (valorController.text.trim().isNotEmpty) {
                  final updatedListaPrecio = ListaPrecio(
                  ...
                  context.read<ListaPrecioBloc>().add(UpdateListaPrecio(updatedListaPrecio));
